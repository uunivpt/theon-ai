...
function displayAnswer(text: string) {
  return text
    // Remove any trailing source/reference/citation section, including bold/italic Markdown headings.
