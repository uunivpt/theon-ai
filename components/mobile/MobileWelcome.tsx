  ...
  return (
    <section className="flex min-h-0 flex-1 flex-col items-center overflow-y-auto bg-black px-5 pb-28 pt-4">
      <div className="flex w-full max-w-[760px] flex-1 flex-col items-center justify-center text-center py-8 sm:py-10 lg:py-14">
        ...
        <div className="mt-5 text-[30px] font-semibold leading-none tracking-[0.18em] text-white sm:text-[33px] lg:text-[35px]">THEON <span className="bg-gradient-to-r from-violet-400 to-cyan-300 bg-clip-text text-transparent">AI</span></div>
